...
class JobListingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('job_listings.index')->with('success', 'Job listing created successfully, you need to wait until your job offer gets approved by admin.');
    }
...
//        if ($jobListing->status !== 'approved' && $jobListing->user_id !== auth()->id()) {
//            abort(404);
//        }
